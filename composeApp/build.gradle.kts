...
afterEvaluate {
    publishing {
        publications {
            ...
            kotlinMultiplatformPub.artifactId = "digi-lib-core"
...
android {
    namespace = "empire.digiprem.corelib"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "empire.digiprem.corelib"
...
compose.desktop {
    application {
        mainClass = "empire.digiprem.corelib.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "empire.digiprem.corelib"
